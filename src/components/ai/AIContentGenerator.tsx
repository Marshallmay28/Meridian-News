    ...
    const generateContent = async () => {
        ...
        try {
            const content = {
                ...
                videoUrl: contentType === 'video' ? '#' : undefined,
                audioUrl: contentType === 'podcast' ? '#' : undefined,
                ...
                deviceId: 'ai-generator',
                isAI: true,
                aiSignature: 'Generated by AI Lab',
                confidence: 0.95,
            }

            saveContent(content)
            toast.success(`${contentType === 'article' ? 'Article' : contentType === 'video' ? 'Video' : 'Podcast'} generated successfully!`)
